...
output_folder = "ADC_data/TI_ADC_output_data_with_env"
...
plt.savefig("Image/TI_ADC_CALIBRATION_WITH_ENV/non ideal output TI-SAR-ADC with env fft .png", dpi=300, bbox_inches="tight")  # Save with high resolution
...
plt.grid(True)                 # Add grid
plt.show()                     # Display the graph
plt.savefig("Image/TI_ADC_CALIBRATION_WITH_ENV/NN output TI-SAR-ADC with env fft .png", dpi=300, bbox_inches="tight")  # Save with high resolution
plt.close()  # Close the plot to free memory
